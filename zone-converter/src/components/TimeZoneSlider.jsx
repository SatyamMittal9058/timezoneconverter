...
function TimeZoneSlider({timezone,onRemove }) {
  ...
  // to calculate new time convert slidervalue to time
  ...
  return (
    <div className="w-full md:w-1/2 m-auto border-2 px-7 py-1 my-3">
      ...
      <Box sx={{ width: "100%" }} className="my-2 text-xs">
        <Slider
          ...
          defaultValue={defaultTimeonScale}
          step={1}
          marks={timeMarks}
          min={0}
          max={287}
